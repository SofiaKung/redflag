...
export async function logAnalysis(data, env) {
  ...
  try {
    ...
    const row = {
      ...
      privacy_protected: verified?.privacyProtected ?? null,
      geo_mismatch: verified?.geoMismatch ?? null,
      homograph_attack: verified?.homographAttack ?? null,
      safe_browsing_threats: verified?.safeBrowsingThreats ?? null,
